...
INSERT INTO [Tickets].[ServiceCatalogSuggestion] ([sourceTicketID_FK], [idaraID_FK], [proposedServiceName_A], [proposedServiceName_E], [proposedServiceDesc_A], [proposedServiceDesc], [proposedTargetDSDID_FK], [proposedPriorityID_FK], [approvalStatus], [approvedByUserID], [approvalDate], [approvalNotes_A], [approvalNotes], [createdServiceID_FK], [suggestionActive], [entryData], [hostName])
VALUES
    (NULL, 1, N'إصلاح سخان مياه',           N'Water Heater Repair',        N'طلبات متكررة لإصلاح سخانات المياه',                N'Recurring Other requests for water heater repairs',   100, 2, N'PENDING',  NULL, NULL,             NULL,                                   NULL,                                    NULL, 1, N'SEED', N'SEED-HOST'),
    (NULL, 1, N'تنظيف خزانات',               N'Tank Cleaning',              N'طلبات دورية لتنظيف الخزانات من السكان',            N'Periodic tank cleaning requests from residents',      101, 4, N'APPROVED', 1,   N'2026-02-15',     N'يوجد طلب متكرر كافٍ',                 N'Sufficient recurring demand',          @svcID1, 1, N'SEED', N'SEED-HOST'),
    (NULL, 1, N'إصلاح باب',                  N'Door Repair',                N'طلبات إصلاح الأبواب والأقفال',                      N'Door and lock repair requests',                       102, 3, N'PENDING',  NULL, NULL,             NULL,                                   NULL,                                    NULL, 1, N'SEED', N'SEED-HOST'),
    (NULL, 1, N'صيانة مصعد',                 N'Elevator Maintenance',       N'أعطال المصاعد والصيانة المجدولة',                   N'Elevator breakdown and scheduled maintenance',        103, 1, N'REJECTED', 2,   N'2026-03-01',     N'مكرر مع خدمة صيانة التكييف الحالية', N'Duplicate of existing AC_MAINTENANCE', NULL, 0, N'SEED', N'SEED-HOST'),
    (NULL, 1, N'تنسيق حدائق',                N'Landscaping',                N'صيانة الحدائق والمناطق الخارجية',                   N'Garden and outdoor area maintenance',                 104, 4, N'PENDING',  NULL, NULL,             NULL,                                   NULL,                                    NULL, 1, N'SEED', N'SEED-HOST');
